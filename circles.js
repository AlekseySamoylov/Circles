...
function init() 
{
	static = new rect("#ccffcc", 0, 0, 600, 700);
	dynamic = new rect("#ffccff", 600, 0, 600, 700);
	balls = [ 	new ball("#22E857", 100, 100, 25, 2, 2),
				...
				new ball("#800080", 380, 250, 30, -2, -1),
				new ball("#FFE4E1", 150, 300, 40, -2, -1),
				new ball("#1E90FF", 40, 190, 30, -1, 2)
			];
	ballsMoving = [];
